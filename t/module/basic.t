...
#
# Copyright 1997-1998, 2000-2002, 2005-2006, 2009-2010, 2012, 2014, 2020, 2024
...
is(
    colorstrip("foo\e[1m", 'bar', "baz\e[0m"),
    'foobarbaz',
    '...and proper joining in scalar context',
);
is(
